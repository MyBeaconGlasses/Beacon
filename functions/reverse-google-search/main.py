...
def generate_signed_url(bucket_name, blob_name):
    ...
    url = blob.generate_signed_url(expiration=datetime.timedelta(minutes=15), version="v4")
...
image_url = f"https://storage.googleapis.com/beacon-image-api/{destination_blob_name}"
