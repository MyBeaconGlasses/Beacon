...
const Gallery = () => {
  ...
  const [isPointSegmentation, setIsPointSegmentation] = useState(true) // Default to Point Segmentation
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 mt-4">
        <label className="flex items-center cursor-pointer">
          <div className="relative">
            <input
              type="checkbox"
              id="segmentationToggle"
              className="sr-only"
              checked={isPointSegmentation}
              onChange={() => {
                setIsPointSegmentation(!isPointSegmentation)
                setOverlayImage('')
              }}
            />
            ...
            <div
              ...
              style={{left: isPointSegmentation ? '1px' : 'calc(100% - 25px)'}}
            ></div>
          </div>
          <div className="ml-3 text-gray-700 font-medium">
            {isPointSegmentation ? 'Point Segmentation' : 'Text Segmentation'}
          </div>
        </label>
      </div>
      ...
      <div className="w-full max-w-4xl">
        {/* Main Image Display */}
        <div className={`mb-8 ${imageSize} mx-auto`}>
          <div className="relative">
            <img
              ref={imageRef}
              src={selectedImage}
              ...
              alt="Selected"
              className="object-cover rounded-md shadow-lg w-96 h-auto"
            />
        ...
        {/* Thumbnails Menu */}
        <div className="flex overflow-x-scroll overflow-y-hidden pb-2">
